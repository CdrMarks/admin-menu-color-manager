...
class Admin_Menu_Color_Manager {
    ...
    public function register_settings() {
        ...
        register_setting(
            'admin_menu_color_group', // Option group
            'amcm_admin_bar_background_color',
            array(
                'type'              => 'string',
                'sanitize_callback' => array( $this, 'sanitize_hex_color' ),
                'default'           => '#23282d', // Default admin bar background
            )
        );

        register_setting(
            'admin_menu_color_group', // Option group
            'amcm_admin_bar_text_color',
            array(
                'type'              => 'string',
                'sanitize_callback' => array( $this, 'sanitize_hex_color' ),
                'default'           => '#eeeeee', // Default admin bar text color
            )
        );

        register_setting(
            'admin_menu_color_group', // Option group
            'amcm_admin_bar_hover_color',
            array(
                'type'              => 'string',
                'sanitize_callback' => array( $this, 'sanitize_hex_color' ),
                'default'           => '#0073aa', // Default admin bar hover color
            )
        );
        ...
        add_settings_field(
            ...
            __( 'Vertical Menu Background Color', 'admin-menu-color-manager' ),          // Title of the field
            ...
            array(
                ...
                'description' => __( 'Choose the main background color for the left-hand admin menu and submenu containers.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_text_color_field',     // ID of the field
            __( 'Vertical Menu Text Color', 'admin-menu-color-manager' ),          // Title of the field
            array( $this, 'render_color_field' ), // Callback to render the field
            'admin-menu-color',                // Page slug
            'amcm_color_settings_section',     // Section ID
            array(
                'option_name' => 'amcm_text_color',
                'description' => __( 'Choose the default color for left-hand menu text and icons.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_hover_background_color_field',     // ID of the field
            __( 'Vertical Menu Item Hover Background Color', 'admin-menu-color-manager' ),          // Title of the field
            array( $this, 'render_color_field' ), // Callback to render the field
            'admin-menu-color',                // Page slug
            'amcm_color_settings_section',     // Section ID
            array(
                'option_name' => 'amcm_hover_background_color',
                'description' => __( 'Choose the background color when hovering over left-hand menu items.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_hover_text_color_field',     // ID of the field
            __( 'Vertical Menu Item Hover Text Color', 'admin-menu-color-manager' ),          // Title of the field
            array( $this, 'render_color_field' ), // Callback to render the field
            'admin-menu-color',                // Page slug
            'amcm_color_settings_section',     // Section ID
            array(
                'option_name' => 'amcm_hover_text_color',
                'description' => __( 'Choose the text and icon color when hovering over left-hand menu items.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_current_item_background_color_field',     // ID of the field
            __( 'Current Vertical Menu Item Background Color', 'admin-menu-color-manager' ),          // Title of the field
            array( $this, 'render_color_field' ), // Callback to render the field
            'admin-menu-color',                // Page slug
            'amcm_color_settings_section',     // Section ID
            array(
                'option_name' => 'amcm_current_item_background_color',
                'description' => __( 'Choose the background color for the currently active left-hand menu item.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_current_item_text_color_field',     // ID of the field
            __( 'Current Vertical Menu Item Text Color', 'admin-menu-color-manager' ),          // Title of the field
            array( $this, 'render_color_field' ), // Callback to render the field
            'admin-menu-color',                // Page slug
            'amcm_color_settings_section',     // Section ID
            array(
                'option_name' => 'amcm_current_item_text_color',
                'description' => __( 'Choose the text and icon color for the currently active left-hand menu item.', 'admin-menu-color-manager' ),
            )
        );

        // Admin Bar Settings
        add_settings_field(
            'amcm_admin_bar_background_color_field',     // ID of the field
            __( 'Admin Bar Background Color', 'admin-menu-color-manager' ),
            array( $this, 'render_color_field' ),
            'admin-menu-color',
            'amcm_color_settings_section',
            array(
                'option_name' => 'amcm_admin_bar_background_color',
                'description' => __( 'Choose the background color for the top horizontal Admin Bar.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_admin_bar_text_color_field',     // ID of the field
            __( 'Admin Bar Text Color', 'admin-menu-color-manager' ),
            array( $this, 'render_color_field' ),
            'admin-menu-color',
            'amcm_color_settings_section',
            array(
                'option_name' => 'amcm_admin_bar_text_color',
                'description' => __( 'Choose the default text and icon color for the top horizontal Admin Bar.', 'admin-menu-color-manager' ),
            )
        );

        add_settings_field(
            'amcm_admin_bar_hover_color_field',     // ID of the field
            __( 'Admin Bar Item Hover/Active Color', 'admin-menu-color-manager' ),
            array( $this, 'render_color_field' ),
            'admin-menu-color',
            'amcm_color_settings_section',
            array(
                'option_name' => 'amcm_admin_bar_hover_color',
                'description' => __( 'Choose the background color for Admin Bar items on hover, and for active/current items.', 'admin-menu-color-manager' ),
            )
        );
    }
    ...
    public function settings_section_callback() {
        echo '<p>' . esc_html__( 'Use the color pickers below to customize the appearance of your WordPress admin menu and top bar.', 'admin-menu-color-manager' ) . '</p>';
    }
    ...
    public function apply_custom_admin_styles() {
        ...
        // Admin Bar Colors
        $admin_bar_background_color = get_option( 'amcm_admin_bar_background_color' );
        $admin_bar_text_color       = get_option( 'amcm_admin_bar_text_color' );
        $admin_bar_hover_color      = get_option( 'amcm_admin_bar_hover_color' );
